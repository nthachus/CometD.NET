...
namespace CometD.Client.Transport
{
	...
	public interface ITransportListener
	{
		...
		void OnSending(IMessage[] messages);
		...
		void OnConnectException(Exception ex, IMessage[] messages);
		...
		/// <param name="ex">The exception that caused the failure.</param>
		/// <param name="messages">The messages being sent.</param>
		void OnException(Exception ex, IMessage[] messages);
		...
		/// </summary>
		/// <param name="messages">The messages being sent.</param>
		void OnExpire(IMessage[] messages);
		...
		/// <param name="ex">The exception that caused the failure.</param>
		/// <param name="messages">The messages being sent.</param>
		void OnProtocolError(string info, Exception ex, IMessage[] messages);
	}
}
